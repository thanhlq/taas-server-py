"""CryptoTokenService tests — ``unit`` layer (runs against a testcontainer).

Exercises the CRUD surface of
:class:`banking_core.crypto.services._crypto_token.CryptoTokenService`,
including creation, retrieval, listing and deletion, using the crypto-token
factory (BTC, ETH, SOL, KAS).
"""
