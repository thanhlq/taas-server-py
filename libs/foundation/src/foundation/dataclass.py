...
from foundation.types import Empty
from foundation.utils.predicates import is_dataclass_instance

if TYPE_CHECKING:
    from typing import AbstractSet, Any, Iterable

    from foundation.types.protocols import DataclassProtocol
