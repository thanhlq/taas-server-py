...
from foundation.utils.predicates import is_async_callable
from foundation.utils.sync import ensure_async_callable

if TYPE_CHECKING:
    from foundation.types import AnyCallable, AsyncAnyCallable
