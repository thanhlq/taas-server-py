...
from foundation.enums import RequestEncodingType
...
if TYPE_CHECKING:
    from foundation.openapi.spec.example import Example
    from foundation.openapi.spec.external_documentation import (
