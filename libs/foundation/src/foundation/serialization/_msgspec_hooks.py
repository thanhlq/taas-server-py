...
from foundation.datastructures.secret_values import SecretBytes, SecretString
from foundation.exceptions import SerializationException
from foundation.types.composite_types import TypeDecodersSequence, TypeEncodersMap
from foundation.types.empty import Empty, EmptyType
from foundation.utils.typing import get_origin_or_inner_type
...
def default_deserializer(
    ...
    from foundation.datastructures.state import ImmutableState
