...
from foundation.exceptions import ImproperlyConfiguredException, LitestarWarning
from foundation.params import BodyKwarg, DependencyKwarg, KwargDefinition, ParameterKwarg
from foundation.types.builtin_types import NoneType, UnionTypes
from foundation.utils.predicates import (
    is_any,
...
from foundation.utils.typing import (
...
class FieldDefinition:
    ...
    def from_parameter(cls, parameter: Parameter, fn_type_hints: dict[str, Any]) -> FieldDefinition:
        ...
        """
        from foundation.datastructures import ImmutableState
        ...
        if parameter.name == "state" and not issubclass(annotation, ImmutableState):
            raise ImproperlyConfiguredException(
                ...
                "It must be typed to a subclass of `foundation.datastructures.ImmutableState` or "
                "`foundation.datastructures.State`."
            )
