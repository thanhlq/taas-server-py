...
import msgspec
from foundation.http.exceptions import ApplicationClientError
...
Username = Annotated[
    str,
    msgspec.Meta(
        description='Username (3-30 characters, alphanumeric/hyphens/underscores)'
    ),
]
...
Slug = Annotated[
    str, msgspec.Meta(description='URL-safe slug (lowercase, alphanumeric, hyphens)')
]
