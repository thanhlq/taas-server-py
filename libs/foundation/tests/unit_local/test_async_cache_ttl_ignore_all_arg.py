"""
Tests for `foundation.utils.cache.async_cache_ttl_ignore_all_arg`.
...
Command: uv run --package foundation pytest -v libs/foundation/tests/unit_local/test_async_cache_ttl_ignore_all_arg.py
"""
...
import pytest
from foundation.utils.cache import a_ttl_cache_ignore_all_args
