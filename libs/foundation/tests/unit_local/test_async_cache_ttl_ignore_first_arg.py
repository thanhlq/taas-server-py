"""
Tests for `foundation.utils.cache.async_cache_ttl_ignore_first_arg`.
...
Command: uv run --package foundation pytest -v libs/foundation/tests/unit_local/test_async_cache_ttl_ignore_first_arg.py
"""

from __future__ import annotations

import pytest
from foundation.utils.cache import a_ttl_cache_ignore_1st_arg
