...
from platform_core.constants import DEFAULT_ALLOWED_CORS_HEADERS

__all__ = ('CORSConfig',)


if TYPE_CHECKING:
    from platform_core.types import Method
...
class CORSConfig:
    ...
    def allowed_origins_regex(self) -> Pattern[str]:
        ...
        origins = [
            re.escape(o.replace('*', _RE_ESCAPE_PLACEHOLDER)).replace(
    ...
    def is_origin_allowed(self, origin: str) -> bool:
        ...
        """
        return bool(
            self.is_allow_all_origins or self.allowed_origins_regex.fullmatch(origin)
        )
