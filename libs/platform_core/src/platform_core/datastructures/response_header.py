...
if TYPE_CHECKING:
    from platform_core.openapi.spec import Example
...
class ResponseHeader:
    ...
    allow_empty_value: bool | None = None  # type: ignore[assignment]
    ...
    allow_reserved: bool | None= None  # type: ignore[assignment]
