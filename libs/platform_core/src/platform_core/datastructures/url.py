...
from platform_core._parsers import parse_query_string
from platform_core.datastructures import MultiDict
from platform_core.types import Empty

if TYPE_CHECKING:
    from typing_extensions import Self

    from platform_core.types import EmptyType, Scope
