...
from platform_core.utils.lang import iscoroutinefunction
...
class TracingDecoratorOptions:
    ...
    @staticmethod
    def set_default_attributes(attributes: Dict[str, str]):
...
def instrument(
    ...
    *,
    ...
    def span_decorator(func_or_class):
        ...
        def _set_semantic_attributes(span: Span, func: Callable):
        ...
        wrapper = (
            ...
            if iscoroutinefunction(func_or_class)
