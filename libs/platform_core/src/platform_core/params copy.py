...
from platform_core.enums import RequestEncodingType
...
if TYPE_CHECKING:
    from platform_core.openapi.spec.example import Example
    from platform_core.openapi.spec.external_documentation import (
