...
from platform_core.exceptions import ImproperlyConfiguredException, LitestarWarning
from platform_core.params import BodyKwarg, DependencyKwarg, KwargDefinition, ParameterKwarg
from platform_core.types.builtin_types import NoneType, UnionTypes
from platform_core.utils.predicates import (
    is_any,
...
from platform_core.utils.typing import (
...
class FieldDefinition:
    ...
    def from_parameter(cls, parameter: Parameter, fn_type_hints: dict[str, Any]) -> FieldDefinition:
        ...
        """
        from platform_core.datastructures import ImmutableState
        ...
        if parameter.name == "state" and not issubclass(annotation, ImmutableState):
            raise ImproperlyConfiguredException(
                ...
                "It must be typed to a subclass of `platform_core.datastructures.ImmutableState` or "
                "`platform_core.datastructures.State`."
            )
